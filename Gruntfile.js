module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      fonts: {
        files: [
          ...
          {expand: true, flatten: true, src: ['bower_components/font-awesome/fonts/*'], dest: 'sphinx_rtd_theme_annotated/static/fonts/', filter: 'isFile'}
        ]
      }
    },
    ...
    sass: {
      dev: {
        ...
        files: [{
          ...
          cwd: 'sass',
          src: ['*.sass'],
          dest: 'sphinx_rtd_theme_annotated/static/css',
          ext: '.css'
        }]
      },
      build: {
    ...
    clean: {
      ...
      fonts: ["sphinx_rtd_theme_annotated/static/fonts"]
    },
    ...
    watch: {
      ...
      sphinx: {
        files: ['sphinx_rtd_theme_annotated/**/*', 'demo_docs/**/*.rst', 'demo_docs/**/*.py'],
